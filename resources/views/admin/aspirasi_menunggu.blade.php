...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="row g-2 mb-3">
                <div class="col-md-4">
                    <select id="filterNisnMenunggu" class="form-select">
                        <option value="">Semua NISN</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <select id="filterNamaMenunggu" class="form-select">
    ...
    <script>
        (() => {
            const nisnSelect = document.getElementById('filterNisnMenunggu');
            const namaSelect = document.getElementById('filterNamaMenunggu');
            const statusSelect = document.getElementById('filterStatusMenunggu');
            const dateInput = document.getElementById('filterDateMenunggu');
