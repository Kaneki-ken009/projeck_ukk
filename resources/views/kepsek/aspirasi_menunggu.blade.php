...
@section('content')
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="row g-2 mb-3">
                <div class="col-md-4">
                    <select id="filterNisnMenungguKepsek" class="form-select">
                        <option value="">Semua NISN</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <select id="filterNamaMenungguKepsek" class="form-select">
                        <option value="">Semua Nama</option>
                    </select>
                </div>
                <div class="col-md-4">
                    <input type="date" id="filterDateMenungguKepsek" class="form-control">
                </div>
            </div>
                            ...
                            <tr class="aspirasi-row"
                                ...
                                <td>
                                    <button class="btn btn-sm btn-outline-secondary" data-bs-toggle="modal"
                                        data-bs-target="#detailModalKepsekMenunggu{{ $a->id_inputaspirasi }}">
                                        Detail
                                    </button>
                                </td>
                            </tr>

                            <div class="modal fade" id="detailModalKepsekMenunggu{{ $a->id_inputaspirasi }}" tabindex="-1" aria-hidden="true">
    ...
    <script>
        (() => {
            const nisnSelect = document.getElementById('filterNisnMenungguKepsek');
            const namaSelect = document.getElementById('filterNamaMenungguKepsek');
            const dateInput = document.getElementById('filterDateMenungguKepsek');
