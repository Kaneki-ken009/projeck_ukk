...
@section('content')
    ...
    <div class="row g-2 mb-3">
        <div class="col-md-4">
            <select id="filterNisnKepsekMenunggu" class="form-select">
                <option value="">Semua NISN</option>
            </select>
        </div>
        <div class="col-md-4">
            <select id="filterNamaKepsekMenunggu" class="form-select">
                <option value="">Semua Nama</option>
            </select>
        </div>
        <div class="col-md-4">
            <select id="filterStatusKepsekMenunggu" class="form-select">
    ...
    <div class="row g-2 mb-3">
        <div class="col-md-4">
            <input type="date" id="filterDateKepsekMenunggu" class="form-control">
        </div>
    </div>
    ...
    <script>
        (() => {
            const nisnSelect = document.getElementById('filterNisnKepsekMenunggu');
            const namaSelect = document.getElementById('filterNamaKepsekMenunggu');
            const statusSelect = document.getElementById('filterStatusKepsekMenunggu');
            const dateInput = document.getElementById('filterDateKepsekMenunggu');
